...
canonical_target: docs/guides/testing-and-quality.md
last_reviewed: 2026-04-18
---
# Test Plan

> Legacy entry page. Canonical architecture doc now lives in `docs/guides/testing-and-quality.md`.
...
请跳转阅读：[`docs/guides/testing-and-quality.md`](guides/testing-and-quality.md)
