...
canonical_target: docs/architecture/overview.md
last_reviewed: 2026-04-18
---
# Architecture Overview

> Legacy entry page. Canonical architecture doc now lives in `docs/architecture/overview.md`.
...
请跳转阅读：[`docs/architecture/overview.md`](architecture/overview.md)
