...
canonical_target: docs/reference/benchmark-suite.md
last_reviewed: 2026-04-18
---
# Benchmark Suite

> Legacy entry page. Canonical architecture doc now lives in `docs/reference/benchmark-suite.md`.
...
请跳转阅读：[`docs/reference/benchmark-suite.md`](reference/benchmark-suite.md)
