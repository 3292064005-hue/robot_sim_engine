...
canonical_target: docs/guides/packaging-and-release.md
last_reviewed: 2026-04-18
---
# Packaging & Release

> Legacy entry page. Canonical architecture doc now lives in `docs/guides/packaging-and-release.md`.
...
请跳转阅读：[`docs/guides/packaging-and-release.md`](guides/packaging-and-release.md)
