...
canonical_target: docs/architecture/execution-model.md
last_reviewed: 2026-04-18
---
# Task Threading Model

> Legacy entry page. Canonical architecture doc now lives in `docs/architecture/execution-model.md`.
...
请跳转阅读：[`docs/architecture/execution-model.md`](architecture/execution-model.md)
