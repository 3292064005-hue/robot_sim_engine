...
class MainWindowActionView(Protocol):
    ...
    def _robot_ops(self) -> RobotFacadeContract: ...
    def _playback_ops(self) -> PlaybackFacadeContract: ...
...
class MainWindowTaskView(Protocol):
    ...
    def _runtime_ops(self) -> RuntimeViewContract: ...
    def _solver_ops(self) -> SolverFacadeContract: ...
    def _trajectory_ops(self) -> TrajectoryFacadeContract: ...
    def _playback_ops(self) -> PlaybackFacadeContract: ...
    def _run_presented(self, callback, *, title: str = '错误'): ...
