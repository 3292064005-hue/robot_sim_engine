...
<<<<<<< HEAD
        ...
        'plugin_catalog': {
            'entries': list(plugin_catalog),
            'counts': {
                'total': len(plugin_catalog),
                'enabled': sum(1 for entry in plugin_catalog if bool(entry.get('enabled'))),
                'disabled': sum(1 for entry in plugin_catalog if not bool(entry.get('enabled'))),
            },
        },
