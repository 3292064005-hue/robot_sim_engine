...
<<<<<<< HEAD
    def update_robot_geometry_projection(self, robot_geometry) -> None:
        ...
        Args:
            robot_geometry: Runtime geometry bundle or ``None`` when unavailable.

        Returns:
            None: The scene widget stores the geometry for live render/snapshot/export flows.

        Raises:
            None: Pure widget projection.
        """
